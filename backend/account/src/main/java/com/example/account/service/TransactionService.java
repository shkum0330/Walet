...
public interface TransactionService {
    ...
    List<TransactionResponse> getTransactionHistory(Long accountId); // 특정 계좌의 거래내역 목록 반환
    List<TransactionResponse> getSpecificPeriodTransaction(TransactionPeriodRequest request); // 특정 기간 내에 속하는 거래내역 목록 반환
}
